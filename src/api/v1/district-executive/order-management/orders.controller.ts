...
@ApiBearerAuth()
@ApiTags('District-Executive / Order-Management')
@Controller('district-executive-order-management')
@PermissionGuard({
...
export class OrdersController {
  ...
  async getNearByVendorList(
    ...
    return await this.vendorManagementService.allApprovedVendors(user, LOCATION.DISTRICT, i18n);
  }
